...
class IntelligencePlatform:
    ...
    def StartCommandThread(self):
        ...
        #self.Log("THREAD IS STARTED!!!")
        self.commandHandlingActive = True
        self.commandQueue = mp.Queue()
        self.commandThread = mp.Process(target = self.ConsoleInput, args=(self.commandQueue,))
        self.commandThread.start()
        #thread.start_new_thread(self.ConsoleInput, (self.commandQueue,))
        #self.commandThread = threading.Thread(None, self.ConsoleInput, args=(self.commandQueue,))
        #self.commandThread.start()
    ...
    def InitializeIntelligence(self):
        ...
        # load IRIS core module
        self.LoadModule("Core")
    ...
    def Display(self, msg):
        self.Log(str(self.entityData["Name"]) + " " + str(self.entityData["Version"]) + "." + str(self.entityData["Build"]) + "> " + msg, LOG_DIALOG)
